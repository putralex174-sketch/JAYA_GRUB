...
// ── Simulasi data (ganti dengan data dari Controller) ────────
if (!isset($pesanan)) {
    // Data dummy untuk preview/testing standalone
    $pesanan = [
        'id'           => 1,
    ...
    $items = [
        ['nama_produk'=>'Eiger Mountaineer Jacket','varian'=>'Hitam / L','harga'=>1250000,'qty'=>1,'gambar_produk'=>null],
        ['nama_produk'=>'Consina Amago 45L',        'varian'=>'Merah',    'harga'=>895000, 'qty'=>1,'gambar_produk'=>null],
    ];
    $sisaDetik = strtotime($pesanan['bayar_sebelum']) - time();
    ...
    <div class="col-lg-8">
      ...
      <form id="payForm" method="POST" action="pembayaran-proses.php" enctype="multipart/form-data">
        ...
        $grup = match($pesanan['metode_bayar']) {
            'bca_transfer','bni_transfer','bri_transfer','mandiri_transfer' => 'bank',
            'gopay','ovo','dana','shopeepay' => 'ewallet',
            'qris' => 'qris',
            'cod'  => 'cod',
            default => 'bank',
        };
